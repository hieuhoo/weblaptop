...
if(isset($_SESSION['dangky'])){
  echo 'XIN CHÀO : '. '<span style ="color:red"; font-size:25px>'.$_SESSION['dangky'].'</span>';
 ...
 ?>
  ...
  <tr>
    <td  colspan="8"><p style="float: left; color: red; font-size: 25PX;">TỔNG TIỀN : <?php  echo number_format ($tongtien,0,',','.').'VNĐ'; ?> </p><br>
    	<p style="float: right;"><button style="background-color: burlywood; font-size:20px; "><a href="pages/main/themgiohang.php?xoatatca=1">XÓA TOÀN BỘ </a></button></p>
