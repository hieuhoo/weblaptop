<?php
	if(isset($_POST['doimatkhau'])){
		...
		if($count > 0){
			...
			echo'<p style="color: green">"Thay đổi thông tin thành công";</p>';
		}else{
			echo'<p style="color: red">"Tài khoản hoặc mật khẩu sai";</p>';
...
<form action="" autocomplete="on" method="POST">
			<table border="1" class="table-login" style="text-align: center;border-collapse: collapse;">
				<tr>
					<td colspan="2"><h3 style="color: red;">Đổi mật khẩu người dùng</h3></td>
				</tr>
				<tr>
					<td>Tài khoản</td>
